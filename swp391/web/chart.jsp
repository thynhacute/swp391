                    ...
                    <div class="pcoded-wrapper">
                        <nav class="pcoded-navbar">
                            ...
                            <div class="pcoded-inner-navbar main-menu">
                                ...
                                <div class="pcoded-navigation-label" data-i18n="nav.category.forms">Student &amp; Recuiter
                                </div>
                                <ul class="pcoded-item pcoded-left-item">
                                    <li>
                                        <a href="form-elements-component.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                            <span class="pcoded-mtext" data-i18n="nav.form-components.main">List student
                                                done OJT</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="bs-basic-table.jsp" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-layers"></i><b>FC</b></span>
                                            <span class="pcoded-mtext" data-i18n="nav.form-components.main">List post
                                                job</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                    </li>
                                ...
                                <div class="pcoded-navigation-label" data-i18n="nav.category.forms">Feedback &amp; News
                                </div>
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="active">
